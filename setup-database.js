...
async function setupDatabase() {
  try {
    ...
    -- Create investors table with all required columns
    ...
    -- Create investment_details table (if needed)
    ...
    if (existingUsers[0].count === 0) {
      ...
      INSERT INTO profiles (id, user_id, role, full_name, phone_number) VALUES
